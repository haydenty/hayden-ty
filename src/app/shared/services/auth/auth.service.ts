...
export class AuthService {
  ...
  auth0 = new auth0.WebAuth({
    clientID: 'zwRvyTuvltQFN1oil4Y68gApWzcjnA5r',
  ...
  public login(): void {
    localStorage.setItem('appRedirectUrl',window.location.pathname.substr(1));
  ...
  public handleAuthentication(): void {
    this.auth0.parseHash((err, authResult) => {
      if (authResult && authResult.accessToken && authResult.idToken) {
        ...
        this.router.navigate([localStorage.getItem('appRedirectUrl')]);
      } else if (err) {
